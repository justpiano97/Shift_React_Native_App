...
import ShiftDetail from '../page/Employer/Main/ShiftList/ShiftDetails';
import ShiftList from '../page/Employer/Main/ShiftList';
  ...
  return (
    <MainLayout isEmployer>
      ...
      >
        ...
        <EmployerStack.Screen name={AppRouter.Employer.Main.ShitList} component={ShiftList} />
        <EmployerStack.Screen name={AppRouter.Employer.Main.ShitDetail} component={ShiftDetail} />
      </EmployerStack.Navigator>
    </MainLayout>
  );
};
